...
class Geomap {
    ...
    draw(selection) {
        ...
        this.dataCountry = selection.datum();
        ...
        */
        ...
        let proj = d3.geoOrthographic().scale(self.properties.scale).translate(self.properties.translate).precision(.1);
...
<<<<<<< Updated upstream
        ...
        function dragstarted(){
            gpos0 = proj.invert(d3.mouse(this));
            o0 = proj.rotate();
        }

        function dragged() {
              var gpos1 = proj.invert(d3.mouse(this));
              o0 = proj.rotate();
              var o1 = eulerAngles(gpos0, gpos1, o0);
              //proj.rotate([ 30, 10, 20 ]);
        }
